...
export class SubItemIndicador_1688085775548 implements MigrationInterface {
  public async up (queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`INSERT INTO SubItemIndicador (CodigoItemIndicador, Descricao, Resumo) VALUES (${prontidao.CodigoItemIndicador}, 'Saudação', 'Atender prontamente dentro dos parametros acordados<BR><BR>- CSF Telefone<BR><BR>- 5 segundos Chat<BR><BR>- 30 segundos<BR><BR>- CRC Multi Telefone<BR><BR>- 5 segundos Chat<BR><BR>- 1 minuto')`)
    await queryRunner.query(`INSERT INTO SubItemIndicador (CodigoItemIndicador, Descricao, Resumo) VALUES (${manutencaoDialogo.CodigoItemIndicador}, 'Manutenção do Diálogo', '-CSF<BR><BR>Fone: 3 minutos ou combinado previamente ;<BR><BR>Chat: 5 minutos ou combinado previamente<BR><BR>- CRC MultiFone: 1 minuto e 30 segundos<BR><BR>- CRC Multi, Mono<BR><BR>Chat/Whats - 4 minutos e/ou combinado previamente<BR><BR>Combinados para cenários específicos:<BR><BR>- Suporte experts<BR><BR>- Contato áreas/N2<BR><BR>- Comandos sistêmicos/PDV')`)
